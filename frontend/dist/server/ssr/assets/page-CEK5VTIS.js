...
import { n as formatEuro, o as getPrograms, s as getUniversities, t as formatDate } from "./catalog-BUkyPvtq.js";
					...
					children: [
						...
						!error && !loading && view === "programs" && programs.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
							...
							children: programs.map((program) => {
								...
								const nextDeadline = program.deadlines.filter((entry) => new Date(entry.deadline).getTime() >= Date.now()).sort((a, b) => a.deadline.localeCompare(b.deadline))[0];
								return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
									...
									children: [
										...
										nextDeadline && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
											...
											children: [
												"Next deadline: ",
												/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: formatDate(nextDeadline.deadline) }),
												" for the ",
												nextDeadline.intake,
												" intake"
											]
