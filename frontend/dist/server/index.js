	...
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("main", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
				className: "relative overflow-hidden border-b border-forest-900/10 bg-cream-50",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
						"aria-hidden": "true",
					...
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
						"aria-hidden": "true",
						className: "absolute -right-48 -top-52 size-[34rem] rounded-full bg-lime-300/20 blur-3xl"
					}),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
								...
								className: "relative overflow-hidden rounded-[1.5rem] border border-forest-900/15 bg-white shadow-[0_30px_80px_rgba(11,43,38,0.14)]",
								children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
							...
							children: [
								...
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("span", {
										className: "font-mono text-xs font-semibold tracking-[0.14em] text-lime-300",
										children: ["0", index + 1]
									}),
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h3", {
									...
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", {
										className: "leading-7 text-white/65",
										children: detail
									})
								]
							}, stage))
...
function BrandMark() {
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("span", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { className: "absolute h-4 w-1 rotate-45 rounded-full bg-lime-300" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { className: "absolute size-2.5 -translate-x-1.5 translate-y-1.5 rounded-full border-2 border-white" })]
	});
}
function Header() {
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("header", {
		className: "relative sticky top-0 z-50 border-b border-forest-900/10 bg-cream-50/92 backdrop-blur-xl",
		children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
			className: "mx-auto flex h-18 max-w-7xl items-center justify-between gap-3 px-5 sm:px-8 lg:px-10",
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(link_default, {
					href: "/",
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(BrandMark, {}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("span", {
						className: "text-[0.94rem] font-semibold tracking-[-0.02em] text-forest-950 sm:text-base",
						children: ["ClearPath ", /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", {
							className: "text-forest-700",
							children: "Germany"
						})]
					})]
...
function NotFound() {
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("main", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
			className: "mx-auto flex min-h-[60vh] max-w-2xl flex-col items-center justify-center px-5 py-20 text-center sm:px-8",
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", {
					className: "section-kicker",
					children: "404"
				...
				/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h1", {
					className: "mt-3 text-4xl font-semibold tracking-[-0.04em] text-forest-950",
					children: "Page not found"
				}),
				/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", {
					className: "mt-4 leading-7 text-slate-600",
					children: "That link does not exist yet, or the address was mistyped. Try one of these instead:"
				}),
...
var page_exports$12 = /* @__PURE__ */ __exportAll({ default: () => page_default$10 });
var page_default$10 = /* @__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'default' is called on server");
}, "50884d0541ab", "default");
//#endregion
//#region app/deadlines/page.tsx
var page_exports$11 = /* @__PURE__ */ __exportAll({ default: () => page_default$9 });
var page_default$9 = /* @__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'default' is called on server");
}, "ecc8ac2ab7d7", "default");
//#endregion
//#region app/explain/page.tsx
var page_exports$10 = /* @__PURE__ */ __exportAll({ default: () => page_default$8 });
var page_default$8 = /* @__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'default' is called on server");
}, "845fe344e112", "default");
//#endregion
...
var page_default$7 = /* @__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'default' is called on server");
}, "fb4e67687240", "default");
//#endregion
//#region app/finance/page.tsx
var page_exports$8 = /* @__PURE__ */ __exportAll({ default: () => page_default$6 });
var page_default$6 = /* @__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'default' is called on server");
}, "8514adbaae9b", "default");
//#endregion
...
var faqs = [
	{
		...
		answer: "No. It is a free, self-guided planning tool. It organizes your steps and points you to official sources, but it does not replace legal or immigration advice."
	},
	{
		question: "Are the deadlines and fees guaranteed to be correct?",
		answer: "The catalog is a hand-curated seed with a verification date on each entry. Requirements change, so always confirm details on the university's official page before acting."
	},
	{
		question: "Do I need APS?",
		answer: "It depends on your country of study. Some countries, such as India, China, and Vietnam, have an APS requirement. Check the APS guide and your local office."
	},
	{
		question: "How much money do I need for the visa?",
		answer: "Financial-proof amounts, including the blocked account minimum, are set by the authorities and updated over time. Confirm the current figure on an official source."
	},
	{
		question: "Can I work while studying?",
		answer: "International students are usually allowed limited part-time work, but the allowance and conditions can change. Verify current rules before taking a job."
	}
];
var glossary = [
	{
...
var metadata = {
	...
	description: "Plain-language guides on the German student visa, APS, uni-assist, finances, insurance, and more."
};
function GuidesPage() {
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("main", {
		id: "main-content",
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h1", {
							...
							children: "Understand every step, in plain language."
						}),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", {
							className: "mt-4 max-w-2xl leading-7 text-slate-600",
							children: "Short, source-conscious guides on the topics students ask about most. High-risk topics always link to an official source with a verification date."
						})
					]
				})
			}),
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("ul", {
						...
						children: guides.map((guide) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(link_default, {
							href: `/guides/${guide.slug}`,
							className: "group flex h-full flex-col rounded-2xl border border-forest-900/10 bg-white p-6 transition hover:border-forest-700/40 hover:shadow-[0_18px_50px_rgba(11,43,38,0.1)]",
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
									className: "flex items-center justify-between",
									children: [guide.highRisk && /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", {
										className: "pill",
										children: "Verify carefully"
									}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("span", {
										className: "ml-auto text-xs text-slate-500",
										children: [guide.readingMinutes, " min"]
									})]
								}),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", {
									className: "mt-3 text-lg font-semibold tracking-[-0.02em] text-forest-950",
								...
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", {
									className: "mt-4 text-sm font-semibold text-forest-700 group-hover:text-forest-600",
									children: "Read guide →"
								})
							]
						}) }, guide.slug))
					...
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", {
							...
							className: "mt-5 divide-y divide-slate-200 rounded-2xl border border-slate-200 bg-white",
							children: faqs.map((item) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("details", {
								className: "group px-6 py-4",
								children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("summary", {
									className: "cursor-pointer list-none font-semibold text-forest-950",
					...
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", {
							...
							children: glossary.map((entry) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
...
var page_exports$6 = /* @__PURE__ */ __exportAll({ default: () => page_default$5 });
var page_default$5 = /* @__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'default' is called on server");
}, "58e12c5a7d93", "default");
//#endregion
//#region app/roadmap/page.tsx
var page_exports$5 = /* @__PURE__ */ __exportAll({ default: () => page_default$4 });
var page_default$4 = /* @__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'default' is called on server");
}, "762691c1dce6", "default");
//#endregion
//#region app/search/page.tsx
var page_exports$4 = /* @__PURE__ */ __exportAll({ default: () => page_default$3 });
var page_default$3 = /* @__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'default' is called on server");
}, "07a43fa182aa", "default");
//#endregion
...
async function generateMetadata({ params }) {
	...
	if (!guide) return { title: "Guide not found | ClearPath Germany" };
	return {
		title: `${guide.title} | ClearPath Germany`,
...
async function GuideDetailPage({ params }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("main", {
		...
		className: "bg-cream-50",
		children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
			className: "mx-auto max-w-3xl px-5 py-10 sm:px-8 lg:px-10",
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(link_default, {
					href: "/guides",
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
							...
							children: [guide.highRisk && /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", {
								...
								className: "text-xs text-slate-500",
								children: [guide.readingMinutes, " min read"]
							})]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h1", {
							className: "mt-3 text-3xl font-semibold tracking-[-0.04em] text-forest-950 sm:text-4xl",
							children: guide.title
						}),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", {
							className: "mt-3 leading-7 text-slate-600",
				...
				/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("article", {
					...
					children: guide.sections.map((section) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", {
						className: "text-xl font-semibold tracking-[-0.02em] text-forest-950",
				...
				/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", {
						...
						children: "Official sources to verify"
					}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("ul", {
						className: "mt-3 space-y-2",
						children: guide.resources.map((resource) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("li", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("a", {
								...
								className: "text-xs text-slate-500",
								children: ["Verified ", formatDate(resource.last_verified)]
							})]
						}, resource.url))
					})]
				}),
				/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", {
					className: "mt-8 rounded-lg bg-amber-50 px-4 py-3 text-sm leading-6 text-amber-800",
					children: "This guide is educational and may become outdated. It is not legal or immigration advice. Always confirm current requirements with the official authority before acting."
				})
			]
		}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(SiteFooter, {})]
	});
...
var routes = [
	...
	},
	{
		...
		ids: {
			"route": "route:/explore/program/:id",
			"page": "page:/explore/program/:id",
			"routeHandler": null,
			"rootBoundary": "root-boundary:/",
			"layouts": ["layout:/"],
			"templates": [],
	...
	},
	{
		...
		ids: {
			"route": "route:/explore/university/:id",
			"page": "page:/explore/university/:id",
			"routeHandler": null,
			"rootBoundary": "root-boundary:/",
			"layouts": ["layout:/"],
			"templates": [],
	...
	},
	{
		...
		ids: {
			"route": "route:/guides/:slug",
			"page": "page:/guides/:slug",
			"routeHandler": null,
			"rootBoundary": "root-boundary:/",
			"layouts": ["layout:/"],
			"templates": [],
...
var _virtual_vinext_rsc_entry_default = createAppRscHandler({
	...
	setNavigationContext: setAppNavigationContext,
	staticParamsMap: {
		"/explore/program/:id": null,
		"/explore/university/:id": null,
		"/guides/:slug": generateStaticParams ?? null
	},
...
//#endregion
//#region ../backend/app/data/cost_of_living.json
var cost_of_living_default = [
	{
		"city": "Munich",
		"monthly_estimate_eur": 1300,
		"notes": "Among the most expensive German cities; rent is the largest cost driver.",
		"last_verified": "2026-07-04"
	},
	{
		"city": "Berlin",
		"monthly_estimate_eur": 1100,
		"notes": "Rising rents but broad housing supply and student options.",
		"last_verified": "2026-07-04"
	},
	{
		"city": "Frankfurt",
		"monthly_estimate_eur": 1150,
		"notes": "Financial hub with higher rent than the national average.",
		"last_verified": "2026-07-04"
	},
	{
		"city": "Hamburg",
		"monthly_estimate_eur": 1100,
		"notes": "Large port city with mid-to-high living costs.",
		"last_verified": "2026-07-04"
	},
	{
		"city": "Cologne",
		"monthly_estimate_eur": 1050,
		"notes": "Moderate costs with a large student population.",
		"last_verified": "2026-07-04"
	},
	{
		"city": "Aachen",
		"monthly_estimate_eur": 950,
		"notes": "Comparatively affordable university city near the border.",
		"last_verified": "2026-07-04"
	},
	{
		"city": "Heidelberg",
		"monthly_estimate_eur": 1050,
		"notes": "Popular student city; rent can be competitive.",
		"last_verified": "2026-07-04"
	},
	{
		"city": "Stuttgart",
		"monthly_estimate_eur": 1100,
		"notes": "Industrial hub with above-average living costs.",
		"last_verified": "2026-07-04"
	},
	{
		"city": "Dresden",
		"monthly_estimate_eur": 900,
		"notes": "One of the more affordable major cities in eastern Germany.",
		"last_verified": "2026-07-04"
	},
	{
		"city": "Bonn",
		"monthly_estimate_eur": 1e3,
		"notes": "Moderate costs with a strong research presence.",
		"last_verified": "2026-07-04"
	},
	{
		"city": "Karlsruhe",
		"monthly_estimate_eur": 980,
		"notes": "Affordable technology-focused city.",
		"last_verified": "2026-07-04"
	},
	{
		"city": "Freiburg",
		"monthly_estimate_eur": 1050,
		"notes": "Attractive southern city; housing can be tight.",
		"last_verified": "2026-07-04"
	},
	{
		"city": "Darmstadt",
		"monthly_estimate_eur": 1e3,
		"notes": "Engineering-focused city near Frankfurt.",
		"last_verified": "2026-07-04"
	},
	{
		"city": "Mannheim",
		"monthly_estimate_eur": 980,
		"notes": "Business-focused city with moderate costs.",
		"last_verified": "2026-07-04"
	}
];
//#endregion
//#region ../backend/app/data/programs.json
var programs_default = /* @__PURE__ */ JSON.parse("[{\"id\":\"tum-msc-informatics\",\"university_id\":\"tum\",\"title\":\"M.Sc. Informatics\",\"degree_level\":\"master\",\"field\":\"Computer Science\",\"language\":\"English\",\"duration_semesters\":4,\"tuition_eur\":0,\"intakes\":[\"winter\",\"summer\"],\"deadlines\":[{\"intake\":\"winter\",\"deadline\":\"2026-05-31\"},{\"intake\":\"summer\",\"deadline\":\"2026-11-30\"}],\"requirements_summary\":\"Recognized bachelor in computer science or related field, proof of English (IELTS/TOEFL), and an aptitude assessment.\",\"official_link\":\"https://www.tum.de/en/studies/degree-programs/detail/informatics-master-of-science-msc\",\"last_verified\":\"2026-07-04\"},{\"id\":\"tum-msc-mechanical\",\"university_id\":\"tum\",\"title\":\"M.Sc. Mechanical Engineering\",\"degree_level\":\"master\",\"field\":\"Mechanical Engineering\",\"language\":\"English\",\"duration_semesters\":4,\"tuition_eur\":0,\"intakes\":[\"winter\"],\"deadlines\":[{\"intake\":\"winter\",\"deadline\":\"2026-05-31\"}],\"requirements_summary\":\"Bachelor in mechanical engineering, English proficiency, and curricular analysis for eligibility.\",\"official_link\":\"https://www.tum.de/en/studies/degree-programs\",\"last_verified\":\"2026-07-04\"},{\"id\":\"tum-bsc-informatics\",\"university_id\":\"tum\",\"title\":\"B.Sc. Informatics\",\"degree_level\":\"bachelor\",\"field\":\"Computer Science\",\"language\":\"German\",\"duration_semesters\":6,\"tuition_eur\":0,\"intakes\":[\"winter\"],\"deadlines\":[{\"intake\":\"winter\",\"deadline\":\"2026-07-15\"}],\"requirements_summary\":\"University entrance qualification, German proficiency (DSH/TestDaF), and possible VPD via uni-assist.\",\"official_link\":\"https://www.tum.de/en/studies/degree-programs\",\"last_verified\":\"2026-07-04\"},{\"id\":\"lmu-msc-data-science\",\"university_id\":\"lmu\",\"title\":\"M.Sc. Data Science\",\"degree_level\":\"master\",\"field\":\"Data Science\",\"language\":\"English\",\"duration_semesters\":4,\"tuition_eur\":0,\"intakes\":[\"winter\"],\"deadlines\":[{\"intake\":\"winter\",\"deadline\":\"2026-05-15\"}],\"requirements_summary\":\"Bachelor with quantitative background, statistics and programming coursework, and English proficiency.\",\"official_link\":\"https://www.lmu.de/en/study/all-degrees-and-programs/\",\"last_verified\":\"2026-07-04\"},{\"id\":\"lmu-ma-economics\",\"university_id\":\"lmu\",\"title\":\"M.Sc. Economics\",\"degree_level\":\"master\",\"field\":\"Economics\",\"language\":\"English\",\"duration_semesters\":4,\"tuition_eur\":0,\"intakes\":[\"winter\"],\"deadlines\":[{\"intake\":\"winter\",\"deadline\":\"2026-03-31\"}],\"requirements_summary\":\"Bachelor in economics with strong quantitative foundation and English proficiency.\",\"official_link\":\"https://www.lmu.de/en/study/all-degrees-and-programs/\",\"last_verified\":\"2026-07-04\"},{\"id\":\"rwth-msc-mechanical\",\"university_id\":\"rwth-aachen\",\"title\":\"M.Sc. Mechanical Engineering\",\"degree_level\":\"master\",\"field\":\"Mechanical Engineering\",\"language\":\"German\",\"duration_semesters\":4,\"tuition_eur\":0,\"intakes\":[\"winter\",\"summer\"],\"deadlines\":[{\"intake\":\"winter\",\"deadline\":\"2026-07-01\"},{\"intake\":\"summer\",\"deadline\":\"2027-01-15\"}],\"requirements_summary\":\"Bachelor in mechanical engineering, German proficiency, and application via uni-assist.\",\"official_link\":\"https://www.rwth-aachen.de/cms/root/studium/studienangebot/~jhx/liste-master/\",\"last_verified\":\"2026-07-04\"},{\"id\":\"rwth-msc-cs\",\"university_id\":\"rwth-aachen\",\"title\":\"M.Sc. Computer Science\",\"degree_level\":\"master\",\"field\":\"Computer Science\",\"language\":\"English\",\"duration_semesters\":4,\"tuition_eur\":0,\"intakes\":[\"winter\",\"summer\"],\"deadlines\":[{\"intake\":\"winter\",\"deadline\":\"2026-03-01\"},{\"intake\":\"summer\",\"deadline\":\"2026-09-01\"}],\"requirements_summary\":\"Bachelor in computer science, English proficiency, and application via uni-assist.\",\"official_link\":\"https://www.rwth-aachen.de/cms/root/studium/studienangebot/~jhx/liste-master/\",\"last_verified\":\"2026-07-04\"},{\"id\":\"tu-berlin-msc-cs\",\"university_id\":\"tu-berlin\",\"title\":\"M.Sc. Computer Science\",\"degree_level\":\"master\",\"field\":\"Computer Science\",\"language\":\"English\",\"duration_semesters\":4,\"tuition_eur\":0,\"intakes\":[\"winter\",\"summer\"],\"deadlines\":[{\"intake\":\"winter\",\"deadline\":\"2026-05-15\"},{\"intake\":\"summer\",\"deadline\":\"2026-11-15\"}],\"requirements_summary\":\"Bachelor in computer science or related field, English proficiency, and application via uni-assist.\",\"official_link\":\"https://www.tu.berlin/en/studying/study-programs\",\"last_verified\":\"2026-07-04\"},{\"id\":\"tu-berlin-msc-ee\",\"university_id\":\"tu-berlin\",\"title\":\"M.Sc. Electrical Engineering\",\"degree_level\":\"master\",\"field\":\"Electrical Engineering\",\"language\":\"German\",\"duration_semesters\":4,\"tuition_eur\":0,\"intakes\":[\"winter\"],\"deadlines\":[{\"intake\":\"winter\",\"deadline\":\"2026-05-15\"}],\"requirements_summary\":\"Bachelor in electrical engineering, German proficiency, and application via uni-assist.\",\"official_link\":\"https://www.tu.berlin/en/studying/study-programs\",\"last_verified\":\"2026-07-04\"},{\"id\":\"hu-berlin-msc-statistics\",\"university_id\":\"hu-berlin\",\"title\":\"M.Sc. Statistics\",\"degree_level\":\"master\",\"field\":\"Statistics\",\"language\":\"English\",\"duration_semesters\":4,\"tuition_eur\":0,\"intakes\":[\"winter\"],\"deadlines\":[{\"intake\":\"winter\",\"deadline\":\"2026-06-30\"}],\"requirements_summary\":\"Bachelor with quantitative methods coursework and English proficiency.\",\"official_link\":\"https://www.hu-berlin.de/en/studies/counselling/course-catalogue\",\"last_verified\":\"2026-07-04\"},{\"id\":\"heidelberg-msc-physics\",\"university_id\":\"heidelberg\",\"title\":\"M.Sc. Physics\",\"degree_level\":\"master\",\"field\":\"Physics\",\"language\":\"English\",\"duration_semesters\":4,\"tuition_eur\":0,\"intakes\":[\"winter\",\"summer\"],\"deadlines\":[{\"intake\":\"winter\",\"deadline\":\"2026-06-15\"},{\"intake\":\"summer\",\"deadline\":\"2026-12-15\"}],\"requirements_summary\":\"Bachelor in physics or related field and English proficiency.\",\"official_link\":\"https://www.uni-heidelberg.de/en/study/all-subjects\",\"last_verified\":\"2026-07-04\"},{\"id\":\"heidelberg-msc-molecular\",\"university_id\":\"heidelberg\",\"title\":\"M.Sc. Molecular Biosciences\",\"degree_level\":\"master\",\"field\":\"Life Sciences\",\"language\":\"English\",\"duration_semesters\":4,\"tuition_eur\":1500,\"intakes\":[\"winter\"],\"deadlines\":[{\"intake\":\"winter\",\"deadline\":\"2026-04-15\"}],\"requirements_summary\":\"Bachelor in biosciences, laboratory experience, and English proficiency.\",\"official_link\":\"https://www.uni-heidelberg.de/en/study/all-subjects\",\"last_verified\":\"2026-07-04\"},{\"id\":\"kit-msc-mechatronics\",\"university_id\":\"kit\",\"title\":\"M.Sc. Mechatronics and Information Technology\",\"degree_level\":\"master\",\"field\":\"Mechatronics\",\"language\":\"German\",\"duration_semesters\":4,\"tuition_eur\":0,\"intakes\":[\"winter\",\"summer\"],\"deadlines\":[{\"intake\":\"winter\",\"deadline\":\"2026-09-30\"},{\"intake\":\"summer\",\"deadline\":\"2027-03-31\"}],\"requirements_summary\":\"Bachelor in a related engineering field and German proficiency.\",\"official_link\":\"https://www.kit.edu/studying/study-offer.php\",\"last_verified\":\"2026-07-04\"},{\"id\":\"tu-darmstadt-msc-ce\",\"university_id\":\"tu-darmstadt\",\"title\":\"M.Sc. Computational Engineering\",\"degree_level\":\"master\",\"field\":\"Computer Science\",\"language\":\"English\",\"duration_semesters\":4,\"tuition_eur\":0,\"intakes\":[\"winter\",\"summer\"],\"deadlines\":[{\"intake\":\"winter\",\"deadline\":\"2026-07-15\"},{\"intake\":\"summer\",\"deadline\":\"2027-01-15\"}],\"requirements_summary\":\"Bachelor in engineering or computer science, mathematics background, and English proficiency.\",\"official_link\":\"https://www.tu-darmstadt.de/studieren/studieninteressierte/\",\"last_verified\":\"2026-07-04\"},{\"id\":\"uni-stuttgart-msc-infotech\",\"university_id\":\"uni-stuttgart\",\"title\":\"M.Sc. Information Technology\",\"degree_level\":\"master\",\"field\":\"Electrical Engineering\",\"language\":\"English\",\"duration_semesters\":4,\"tuition_eur\":0,\"intakes\":[\"winter\",\"summer\"],\"deadlines\":[{\"intake\":\"winter\",\"deadline\":\"2026-07-15\"},{\"intake\":\"summer\",\"deadline\":\"2027-01-15\"}],\"requirements_summary\":\"Bachelor in electrical engineering or computer science and English proficiency.\",\"official_link\":\"https://www.uni-stuttgart.de/en/study/study-programs/\",\"last_verified\":\"2026-07-04\"},{\"id\":\"uni-freiburg-msc-renewable\",\"university_id\":\"uni-freiburg\",\"title\":\"M.Sc. Renewable Energy Engineering and Management\",\"degree_level\":\"master\",\"field\":\"Energy\",\"language\":\"English\",\"duration_semesters\":4,\"tuition_eur\":3000,\"intakes\":[\"winter\"],\"deadlines\":[{\"intake\":\"winter\",\"deadline\":\"2026-03-15\"}],\"requirements_summary\":\"Bachelor in engineering, sciences, or economics with relevant background and English proficiency.\",\"official_link\":\"https://www.studium.uni-freiburg.de/en/study-programs\",\"last_verified\":\"2026-07-04\"},{\"id\":\"goethe-frankfurt-msc-finance\",\"university_id\":\"goethe-frankfurt\",\"title\":\"M.Sc. Money and Finance\",\"degree_level\":\"master\",\"field\":\"Finance\",\"language\":\"English\",\"duration_semesters\":4,\"tuition_eur\":0,\"intakes\":[\"winter\"],\"deadlines\":[{\"intake\":\"winter\",\"deadline\":\"2026-05-31\"}],\"requirements_summary\":\"Bachelor in economics or finance with quantitative coursework and English proficiency.\",\"official_link\":\"https://www.goethe-university-frankfurt.de/en/study/degree-programs\",\"last_verified\":\"2026-07-04\"},{\"id\":\"uni-hamburg-msc-cs\",\"university_id\":\"uni-hamburg\",\"title\":\"M.Sc. Computer Science\",\"degree_level\":\"master\",\"field\":\"Computer Science\",\"language\":\"English\",\"duration_semesters\":4,\"tuition_eur\":0,\"intakes\":[\"winter\",\"summer\"],\"deadlines\":[{\"intake\":\"winter\",\"deadline\":\"2026-05-31\"},{\"intake\":\"summer\",\"deadline\":\"2026-11-30\"}],\"requirements_summary\":\"Bachelor in computer science or related field and English proficiency.\",\"official_link\":\"https://www.uni-hamburg.de/en/studium/studienangebot.html\",\"last_verified\":\"2026-07-04\"},{\"id\":\"uni-koeln-msc-management\",\"university_id\":\"uni-koeln\",\"title\":\"M.Sc. Business Administration\",\"degree_level\":\"master\",\"field\":\"Business\",\"language\":\"English\",\"duration_semesters\":4,\"tuition_eur\":0,\"intakes\":[\"winter\"],\"deadlines\":[{\"intake\":\"winter\",\"deadline\":\"2026-06-15\"}],\"requirements_summary\":\"Bachelor in business or economics, quantitative methods, and English proficiency.\",\"official_link\":\"https://www.wiso.uni-koeln.de/en/studies\",\"last_verified\":\"2026-07-04\"},{\"id\":\"uni-bonn-msc-economics\",\"university_id\":\"uni-bonn\",\"title\":\"M.Sc. Economics\",\"degree_level\":\"master\",\"field\":\"Economics\",\"language\":\"English\",\"duration_semesters\":4,\"tuition_eur\":0,\"intakes\":[\"winter\"],\"deadlines\":[{\"intake\":\"winter\",\"deadline\":\"2026-03-15\"}],\"requirements_summary\":\"Bachelor in economics with strong quantitative foundation and English proficiency.\",\"official_link\":\"https://www.uni-bonn.de/en/studying/study-programs\",\"last_verified\":\"2026-07-04\"},{\"id\":\"tu-dresden-msc-nanoelectronics\",\"university_id\":\"tu-dresden\",\"title\":\"M.Sc. Nanoelectronic Systems\",\"degree_level\":\"master\",\"field\":\"Electrical Engineering\",\"language\":\"English\",\"duration_semesters\":4,\"tuition_eur\":0,\"intakes\":[\"winter\"],\"deadlines\":[{\"intake\":\"winter\",\"deadline\":\"2026-05-31\"}],\"requirements_summary\":\"Bachelor in electrical engineering or related field and English proficiency.\",\"official_link\":\"https://tu-dresden.de/studium/vor-dem-studium/studienangebot\",\"last_verified\":\"2026-07-04\"},{\"id\":\"uni-mannheim-msc-management\",\"university_id\":\"uni-mannheim\",\"title\":\"M.Sc. Management\",\"degree_level\":\"master\",\"field\":\"Business\",\"language\":\"English\",\"duration_semesters\":4,\"tuition_eur\":0,\"intakes\":[\"winter\",\"summer\"],\"deadlines\":[{\"intake\":\"winter\",\"deadline\":\"2026-06-30\"},{\"intake\":\"summer\",\"deadline\":\"2026-11-30\"}],\"requirements_summary\":\"Bachelor in business or economics with strong grades and English proficiency.\",\"official_link\":\"https://www.uni-mannheim.de/en/academics/programs/\",\"last_verified\":\"2026-07-04\"},{\"id\":\"uni-mannheim-bsc-business\",\"university_id\":\"uni-mannheim\",\"title\":\"B.Sc. Business Administration\",\"degree_level\":\"bachelor\",\"field\":\"Business\",\"language\":\"German\",\"duration_semesters\":6,\"tuition_eur\":0,\"intakes\":[\"winter\"],\"deadlines\":[{\"intake\":\"winter\",\"deadline\":\"2026-07-15\"}],\"requirements_summary\":\"University entrance qualification, German proficiency, and possible VPD via uni-assist.\",\"official_link\":\"https://www.uni-mannheim.de/en/academics/programs/\",\"last_verified\":\"2026-07-04\"},{\"id\":\"passau-msc-computer-science\",\"university_id\":\"uni-passau\",\"title\":\"M.Sc. Computer Science\",\"degree_level\":\"master\",\"field\":\"Computer Science\",\"language\":\"English\",\"duration_semesters\":4,\"tuition_eur\":0,\"intakes\":[\"winter\",\"summer\"],\"deadlines\":[{\"intake\":\"summer\",\"deadline\":\"2026-12-15\",\"deadline_note\":\"Official summer application period is 1 November to 15 December; shown for summer semester 2027.\"},{\"intake\":\"winter\",\"deadline\":\"2027-05-31\",\"deadline_note\":\"Official winter deadline is 31 May for direct and uni-assist applications; shown for winter semester 2027.\"}],\"requirements_summary\":\"Bachelor in computer science or a related discipline with at least 110 ECTS in computer science, qualifying grade/ranking, thesis or research-paper abstract, and English or German language proof. A1 German is required by the end of the first year if studying only in English.\",\"official_link\":\"https://www.uni-passau.de/en/msc-computer-science\",\"last_verified\":\"2026-07-09\",\"source_note\":\"Official page states no tuition fees and lists direct/uni-assist winter windows plus the summer window.\"},{\"id\":\"ovgu-msc-data-knowledge-engineering\",\"university_id\":\"ovgu-magdeburg\",\"title\":\"M.Sc. Data and Knowledge Engineering\",\"degree_level\":\"master\",\"field\":\"Data Science\",\"language\":\"English\",\"duration_semesters\":4,\"tuition_eur\":0,\"intakes\":[\"winter\",\"summer\"],\"deadlines\":[{\"intake\":\"summer\",\"deadline\":\"2026-11-15\",\"deadline_note\":\"International bachelor's degree applicants apply via uni-assist by 15 November; shown for summer semester 2027.\"},{\"intake\":\"winter\",\"deadline\":\"2027-05-15\",\"deadline_note\":\"International bachelor's degree applicants apply via uni-assist by 15 May; shown for winter semester 2027.\"}],\"requirements_summary\":\"Bachelor in computer science, data science, statistics, or a related field with required CS/statistics coursework, minimum German-scale grade of 2.30, and German or English at C1.\",\"official_link\":\"https://www.ovgu.de/en/Study/Study+Programmes/Master/Data+and+Knowledge+Engineering.html\",\"last_verified\":\"2026-07-09\",\"source_note\":\"Official page separates deadlines for German bachelor's applicants and international bachelor's applicants; catalog uses the international/uni-assist dates relevant to Indian applicants.\"},{\"id\":\"ovgu-msc-digital-engineering\",\"university_id\":\"ovgu-magdeburg\",\"title\":\"M.Sc. Digital Engineering\",\"degree_level\":\"master\",\"field\":\"Engineering\",\"language\":\"English\",\"duration_semesters\":4,\"tuition_eur\":0,\"intakes\":[\"winter\",\"summer\"],\"deadlines\":[{\"intake\":\"summer\",\"deadline\":\"2026-11-15\",\"deadline_note\":\"International bachelor's degree applicants apply via uni-assist by 15 November; shown for summer semester 2027.\"},{\"intake\":\"winter\",\"deadline\":\"2027-05-15\",\"deadline_note\":\"International bachelor's degree applicants apply via uni-assist by 15 May; shown for winter semester 2027.\"}],\"requirements_summary\":\"Bachelor in digital engineering, engineering, computer science, or a related field with a minimum German-scale grade of 2.50 and German or English at C1. The program can be completed in English.\",\"official_link\":\"https://www.ovgu.de/en/Study/Study+Programmes/Master/Digital+Engineering.html\",\"last_verified\":\"2026-07-09\",\"source_note\":\"Official page separates deadlines for German bachelor's applicants and international bachelor's applicants; catalog uses the international/uni-assist dates relevant to Indian applicants.\"},{\"id\":\"h-brs-msc-autonomous-systems\",\"university_id\":\"h-brs\",\"title\":\"M.Sc. Autonomous Systems\",\"degree_level\":\"master\",\"field\":\"Robotics\",\"language\":\"English\",\"duration_semesters\":4,\"tuition_eur\":0,\"intakes\":[\"winter\",\"summer\"],\"deadlines\":[{\"intake\":\"summer\",\"deadline\":\"2026-07-15\",\"deadline_note\":\"Visa-required applicants with a foreign bachelor's degree apply via uni-assist from 15 May to 15 July for the following summer semester; shown for summer semester 2027.\"},{\"intake\":\"winter\",\"deadline\":\"2027-02-15\",\"deadline_note\":\"Visa-required applicants with a foreign bachelor's degree apply via uni-assist from 15 November to 15 February for the respective winter semester; shown for winter semester 2027.\"}],\"requirements_summary\":\"Bachelor or equivalent with sufficient computer science content, minimum German-scale grade of 2.5, CV, motivation letter, and recognized English proof at B2+ CEFR. No German certificate is required.\",\"official_link\":\"https://www.h-brs.de/en/inf/admission-application-master-autonomous-systems\",\"last_verified\":\"2026-07-09\",\"source_note\":\"Official H-BRS admission page distinguishes visa-required applicants and routes them through uni-assist; catalog uses that India-relevant deadline track.\"}]");
//#endregion
//#region worker/clearpath-api.ts
var universities = [
	{
		"id": "tum",
	...
	},
	{
		...
		"application_route": "mixed",
		"vpd_required": true,
		"semester_fee_eur": 129,
		"languages": ["German", "English"],
		"official_link": "https://www.lmu.de/en/study/important-information/application-and-admissions/index.html",
		"last_verified": "2026-07-04"
	},
	{
		"id": "rwth-aachen",
		...
		"application_route": "uni-assist",
		"vpd_required": false,
		"semester_fee_eur": 320,
		"languages": ["German", "English"],
		"official_link": "https://www.rwth-aachen.de/cms/root/studium/im-studium/~elm/bewerbung/",
		"last_verified": "2026-07-04"
	},
	{
		"id": "tu-berlin",
		...
		"languages": ["German", "English"],
		"official_link": "https://www.tu.berlin/en/studying/study-programs/apply",
		"last_verified": "2026-07-04"
	},
	{
		"id": "hu-berlin",
		...
		"languages": ["German", "English"],
		"official_link": "https://www.hu-berlin.de/en/studies/counselling/application",
		"last_verified": "2026-07-04"
	},
	{
		"id": "heidelberg",
		...
		"application_route": "direct",
		"vpd_required": false,
		"semester_fee_eur": 171,
		"languages": ["German", "English"],
		"official_link": "https://www.uni-heidelberg.de/en/study/all-subjects/application",
		"last_verified": "2026-07-04"
	},
	{
		"id": "kit",
		...
		"application_route": "direct",
		"vpd_required": false,
		"semester_fee_eur": 178,
		"languages": ["German", "English"],
		"official_link": "https://www.kit.edu/studying/application.php",
		"last_verified": "2026-07-04"
	},
	{
		"id": "tu-darmstadt",
		...
		"application_route": "uni-assist",
		"vpd_required": false,
		"semester_fee_eur": 289,
		"languages": ["German", "English"],
		"official_link": "https://www.tu-darmstadt.de/studieren/studieninteressierte/application_master/index.en.jsp",
		"last_verified": "2026-07-04"
	},
	{
		"id": "uni-stuttgart",
		...
		"application_route": "mixed",
		"vpd_required": false,
		"semester_fee_eur": 195,
		"languages": ["German", "English"],
		"official_link": "https://www.uni-stuttgart.de/en/study/application/",
		"last_verified": "2026-07-04"
	},
	{
		"id": "uni-freiburg",
		...
		"application_route": "direct",
		"vpd_required": false,
		"semester_fee_eur": 165,
		"languages": ["German", "English"],
		"official_link": "https://www.studium.uni-freiburg.de/en/application",
		"last_verified": "2026-07-04"
	},
	{
		"id": "goethe-frankfurt",
		...
		"application_route": "uni-assist",
		"vpd_required": false,
		"semester_fee_eur": 370,
		"languages": ["German", "English"],
		"official_link": "https://www.goethe-university-frankfurt.de/en/study/application",
		"last_verified": "2026-07-04"
	},
	{
		"id": "uni-hamburg",
		...
		"application_route": "uni-assist",
		"vpd_required": false,
		"semester_fee_eur": 335,
		"languages": ["German", "English"],
		"official_link": "https://www.uni-hamburg.de/en/campuscenter/bewerbung.html",
		"last_verified": "2026-07-04"
	},
	{
		"id": "uni-koeln",
		...
		"languages": ["German", "English"],
		"official_link": "https://www.portal.uni-koeln.de/en/international/pre-arrival/study-programmes/application",
		"last_verified": "2026-07-04"
	},
	{
		"id": "uni-bonn",
		...
		"semester_fee_eur": 315,
		"languages": ["German", "English"],
		"official_link": "https://www.uni-bonn.de/en/studying/application-and-enrolment",
		"last_verified": "2026-07-04"
	},
	{
		"id": "tu-dresden",
		...
		"languages": ["German", "English"],
		"official_link": "https://tu-dresden.de/studium/vor-dem-studium/bewerbung",
		"last_verified": "2026-07-04"
	},
	{
		"id": "uni-mannheim",
		...
		"semester_fee_eur": 195,
		"languages": ["German", "English"],
		"official_link": "https://www.uni-mannheim.de/en/academics/applying/",
		"last_verified": "2026-07-04"
	},
	{
		"id": "uni-passau",
		...
		"application_route": "mixed",
		"vpd_required": false,
		"semester_fee_eur": 127,
		"languages": ["German", "English"],
		"official_link": "https://www.uni-passau.de/en/apply",
		"last_verified": "2026-07-09",
		"source_note": "Semester fee is EUR 126.90 for winter semester 2026/27; application method depends on the applicant profile and may be direct or via uni-assist."
	},
	{
		"id": "ovgu-magdeburg",
		...
		"application_route": "uni-assist",
		"vpd_required": false,
		"semester_fee_eur": 329,
		"languages": ["German", "English"],
		"official_link": "https://www.ovgu.de/en/Study/Study+Programmes.html",
		"last_verified": "2026-07-09",
		"source_note": "International applicants with an international bachelor's degree apply via uni-assist for the listed English-taught master's programs; semester fee page lists EUR 329.30."
	},
	{
		"id": "h-brs",
		...
		"state": "North Rhine-Westphalia",
		"type": "public",
		"website": "https://www.h-brs.de/en",
		"application_route": "uni-assist",
		"vpd_required": false,
		"semester_fee_eur": 367,
		"languages": ["English", "German"],
		"official_link": "https://www.h-brs.de/en/study",
		"last_verified": "2026-07-09",
		"source_note": "Visa-required applicants with a foreign bachelor's degree use uni-assist for the Autonomous Systems M.Sc.; winter 2026/27 semester fee is EUR 367.00."
	}
];
var programs = programs_default;
var universityById = new Map(universities.map((item) => [item.id, item]));
var headers = { "Content-Type": "application/json; charset=utf-8" };
var json = (payload, status = 200) => new Response(JSON.stringify(payload), {
	status,
	headers
});
var detail = (message, status) => json({ detail: message }, status);
var same = (left, right) => left.toLocaleLowerCase() === right.toLocaleLowerCase();
function filteredUniversities(params) {
	...
	return universities.filter((item) => (!city || same(item.city, city)) && (!state || same(item.state, state)) && (!type || item.type === type.toLocaleLowerCase()) && (!language || item.languages.some((value) => same(value, language))) && (!search || item.name.toLocaleLowerCase().includes(search) || item.city.toLocaleLowerCase().includes(search) || item.state.toLocaleLowerCase().includes(search)));
}
function filteredPrograms(params) {
	...
	return programs.filter((item) => {
		...
		return (!universityId || item.university_id === universityId) && (!degree || item.degree_level === degree.toLocaleLowerCase()) && (!language || same(item.language, language)) && (!field || item.field.toLocaleLowerCase().includes(field)) && (!city || Boolean(university && same(university.city, city))) && (!intake || item.intakes.includes(intake)) && (maximum === null || item.tuition_eur <= maximum) && (!search || item.title.toLocaleLowerCase().includes(search) || item.field.toLocaleLowerCase().includes(search) || Boolean(university?.name.toLocaleLowerCase().includes(search)));
	});
}
function deadlines(params) {
	...
	return programs.flatMap((program) => {
		...
		return program.deadlines.filter((entry) => !intake || entry.intake === intake).map((entry) => ({
			...
			...entry.deadline_note ? { deadline_note: entry.deadline_note } : {},
			...program.source_note ? { source_note: program.source_note } : {}
		}));
	}).sort((a, b) => String(a.deadline).localeCompare(String(b.deadline)));
}
var roadmapEnums = {
	education_status: new Set([
		"highschool",
		"bachelor_in_progress",
		"bachelor_done",
		"master_done"
	]),
	target_degree: new Set(["bachelor", "master"]),
	target_intake: new Set(["winter", "summer"]),
	aps_status: new Set([
		"required",
		"not_required",
		"unsure"
	]),
	study_language: new Set(["English", "German"]),
	language_test_status: new Set([
		"not_started",
		"preparing",
		"passed"
	]),
	admission_status: new Set([
		"researching",
		"applied",
		"admitted"
	]),
	finance_status: new Set([
		"not_started",
		"in_progress",
		"ready"
	]),
...
function roadmapActions(profile, stage) {
	const actions = [];
	if (stage === "plan") {
...
function roadmapDocuments(stage, profile) {
	...
	if (stage === "plan" || stage === "prepare") {
		now.push("Language test registration or result");
		if (profile.aps_status === "required") now.push("APS certificate (start early)");
		later.push("Financial proof (blocked account confirmation)", "Visa application forms");
	} else if (stage === "apply") {
		now.push("CV and statement of purpose", "Language certificate");
		later.push("Admission letter", "Blocked account confirmation");
	} else if (stage === "visa") {
		now.push("Admission letter", "Blocked account confirmation or equivalent financial proof", "Health insurance for the visa");
		later.push("Residence permit documents after arrival");
	} else {
		now.push("Admission and enrollment documents", "Visa and financial proof originals");
		later.push("Anmeldung confirmation (needed for many services)");
	}
	return [now, later];
}
var weeklyPlans = {
...
function generateRoadmap(profile) {
	...
	if ([
		...
		"prepare",
		"apply"
	].includes(stage)) resources.push(assistResource);
	if ([
		"apply",
		"visa",
		"arrival"
	].includes(stage)) resources.push(visaResource);
	return {
		stage,
		stage_title: title,
		stage_summary: summary,
		next_actions: roadmapActions(profile, stage),
		documents_now: now,
		documents_later: later,
		weekly_plan: weeklyPlans[stage].map((focus, index) => ({
			week: index + 1,
			focus
		})),
		common_mistakes: mistakes[stage],
		resources,
...
var questions = {
	admission: ["Which conditions must I fulfill, and by which exact date?", "How do I formally accept, and is a deposit or fee required?"],
	rejection: ["Can you share the reason for the rejection?", "Am I eligible to reapply for the next intake?"],
	visa: ["Is my document set complete for the appointment, or is anything missing?", "How long is the current processing time after the appointment?"],
	blocked_account: ["When will the confirmation letter be issued after funding?", "Is the amount I deposited sufficient under the current requirement?"],
	insurance: ["From which date is my coverage active?", "Is this plan accepted for university enrollment and the visa?"],
	uni_assist: ["Which documents are still missing from my application?", "When can I expect the evaluation result?"],
	aps: ["Are my submitted documents complete for the verification?", "How long does the certificate currently take to issue?"],
	payment: ["Can you confirm the official bank details and the exact amount?", "What happens if the payment arrives after the deadline?"],
	enrollment: ["Which steps remain to complete my enrollment?", "Which original documents must I present, and where?"],
	general: ["Could you confirm exactly what you need from me, and by when?", "Is there an official portal where I can complete this step?"]
};
var subjects = {
...
function explain(text) {
	...
	let risk_level = "low", risk_reason = "No urgent or high-stakes language was detected, but read it fully yourself.";
	if (highs.length && (dates.length || highs.length > 1)) {
		risk_level = "high";
		risk_reason = `The text contains time-critical or high-stakes language (${[...new Set(highs)].sort().slice(0, 4).join(", ")}). Act before any stated date.`;
	} else if (highs.length || mediums.length && dates.length) {
		risk_level = "medium";
		risk_reason = "The text asks for action and mentions dates or requirements. Missing them could delay your process.";
	} else if (mediums.length) {
		risk_level = "medium";
		risk_reason = "The text asks you to do or confirm something. Respond promptly.";
	}
	return {
		category,
		...
		required_actions: actions[category],
...
async function bodyOf(request) {
	try {
		...
		return detail("Request body must be valid JSON.", 422);
	}
}
async function handleClearPathApi(request) {
	const url = new URL(request.url);
	...
	if (request.method === "GET") {
		...
		if (url.pathname.startsWith("/api/universities/")) {
			const item = universityById.get(decodeURIComponent(url.pathname.slice(18)));
			return item ? json(item) : detail("University not found", 404);
		}
		if (url.pathname === "/api/programs") {
			const result = filteredPrograms(url.searchParams);
			return result instanceof Response ? result : json(result);
		}
		if (url.pathname.startsWith("/api/programs/")) {
			const id = decodeURIComponent(url.pathname.slice(14)), item = programs.find((program) => program.id === id);
			return item ? json(item) : detail("Program not found", 404);
		}
		if (url.pathname === "/api/deadlines") return json(deadlines(url.searchParams));
		if (url.pathname === "/api/cost-of-living") return json(cost_of_living_default);
		return detail("Not found", 404);
	}
	if (request.method === "POST") {
		if (url.pathname === "/api/roadmap/generate") {
			const body = await bodyOf(request);
			if (body instanceof Response) return body;
			const profile = roadmapProfile(body);
			return profile ? json(generateRoadmap(profile)) : detail("Invalid roadmap profile.", 422);
		}
		if (url.pathname === "/api/explain") {
			const body = await bodyOf(request);
			if (body instanceof Response) return body;
			const text = body && typeof body === "object" && !Array.isArray(body) ? body.text : null;
			return typeof text === "string" && text.length >= 40 && text.length <= 8e3 ? json(explain(text)) : detail("Text must be between 40 and 8000 characters.", 422);
		}
		return detail("Not found", 404);
	}
...
var worker_entry_default = { async fetch(request, env, ctx) {
	const url = new URL(request.url);
	const apiResponse = await handleClearPathApi(request);
